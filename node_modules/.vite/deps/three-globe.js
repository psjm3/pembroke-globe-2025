import {
  ...
  LineMaterial,
  TextGeometry
} from "./chunk-CLQXF7MI.js";
import {
  index
} from "./chunk-YOFFV4YW.js";
import {
  index as index2
} from "./chunk-DRPRKZTI.js";
import {
  Easing,
  Group as Group2,
  Tween
} from "./chunk-RIX3YKBV.js";
import {
  CSS2DObject
} from "./chunk-JWE7FNYU.js";
import {
  BackSide,
  BoxGeometry,
  BufferAttribute,
    ...
    if (prevPnt) {
      ...
      if (dist2 > maxDegDistance) {
        ...
        var interpol = altInterpol ? function(t4) {
          return [].concat(_toConsumableArray(geoInterpol(t4)), [altInterpol(t4)]);
        } : geoInterpol;
...
var DataBindMapper = function() {
  ...
  return _createClass2(DataBindMapper2, [{
    ...
    value: function entries() {
      return _toConsumableArray2(_classPrivateFieldGet2(_objMap, this).entries()).map(function(_ref) {
        var _ref2 = _slicedToArray2(_ref, 2), o = _ref2[0], d = _ref2[1];
        return [d, o];
      });
    }
  }, {
...
function quantize() {
  var x03 = 0, x12 = 1, n = 1, domain = [0.5], range3 = [0, 1], unknown;
  function scale2(x) {
  ...
  scale2.copy = function() {
    return quantize().domain([x03, x12]).range(range3).unknown(unknown);
  };
...
function geoPolygonTriangulate(polygon) {
  ...
  var _geoBounds = bounds_default(boundariesGeojson), _geoBounds2 = _slicedToArray3(_geoBounds, 2), _geoBounds2$ = _slicedToArray3(_geoBounds2[0], 2), minLng = _geoBounds2$[0], minLat = _geoBounds2$[1], _geoBounds2$2 = _slicedToArray3(_geoBounds2[1], 2), maxLng = _geoBounds2$2[0], maxLat = _geoBounds2$2[1];
  ...
  if (crossesPoleOrAntimeridian) {
    ...
    var pntMap = new Map(points.map(function(_ref2, idx) {
      var _ref3 = _slicedToArray3(_ref2, 2), lng = _ref3[0], lat = _ref3[1];
    ...
    vt.features.forEach(function(f) {
      ...
      triangle.forEach(function(_ref4) {
        var _ref5 = _slicedToArray3(_ref4, 2), lng = _ref5[0], lat = _ref5[1];
  ...
  var uvs = points.map(function(_ref6) {
    var _ref7 = _slicedToArray3(_ref6, 2), lng = _ref7[0], lat = _ref7[1];
...
function getInnerGeoPoints(polygon, maxDistance) {
  ...
  var _geoBounds3 = bounds_default(boundariesGeojson), _geoBounds4 = _slicedToArray3(_geoBounds3, 2), _geoBounds4$ = _slicedToArray3(_geoBounds4[0], 2), minLng = _geoBounds4$[0], minLat = _geoBounds4$[1], _geoBounds4$2 = _slicedToArray3(_geoBounds4[1], 2), maxLng = _geoBounds4$2[0], maxLat = _geoBounds4$2[1];
...
var ConicPolygonGeometry = function(_THREE$BufferGeometry) {
  function ConicPolygonGeometry2(polygonGeoJson, startHeight, endHeight, closedBottom, closedTop, includeSides, curvatureResolution) {
    var _this;
    _classCallCheck3(this, ConicPolygonGeometry2);
    _this = _callSuper2(this, ConicPolygonGeometry2);
  ...
  _inherits2(ConicPolygonGeometry2, _THREE$BufferGeometry);
  return _createClass3(ConicPolygonGeometry2);
    ...
    (function flatten3(node) {
      ...
      if (accKeys.length === keys.length) {
        ...
        Object.entries(node).forEach(function(_ref2) {
          ...
          return flatten3(val, [].concat(_toConsumableArray4(accKeys), [key]));
        });
      }
    })(indexedResult);
...
var libh3 = function(libh32) {
  ...
  var asm = (
    ...
    function(global, env, buffer2) {
      "almost asm";
      var a = new global.Int8Array(buffer2), b = new global.Int32Array(buffer2), c3 = new global.Uint8Array(buffer2), d = new global.Float32Array(buffer2), e = new global.Float64Array(buffer2), f = env.o | 0, g = env.p | 0, p = global.Math.floor, q = global.Math.abs, r = global.Math.sqrt, s = global.Math.pow, t = global.Math.cos, u4 = global.Math.sin, v2 = global.Math.tan, w = global.Math.acos, x = global.Math.asin, y = global.Math.atan, z = global.Math.atan2, A5 = global.Math.ceil, B3 = global.Math.imul, C3 = global.Math.min, D3 = global.Math.max, E2 = global.Math.clz32, G = env.b, H = env.c, I = env.d, J = env.e, K2 = env.f, L = env.g, M2 = env.h, N = env.i, T = 24160;
      ...
      function cd2(a2, c4, d2) {
        ...
        do {
          if (!f2) {
            ...
            while (1) {
              if (_b(f2, c4) | 0 ? _b(f2 + 16 | 0, d2) | 0 : 0) {
                break;
              }
              g2 = b[f2 + 32 >> 2] | 0;
              f2 = (g2 | 0) == 0 ? f2 : g2;
      ...
      function dd(a2, c4, d2) {
        ...
        a2 = g2;
        while (1) {
          if (_b(a2, c4) | 0 ? _b(a2 + 16 | 0, d2) | 0 : 0) {
            f2 = 10;
            break;
          }
          a2 = b[a2 + 32 >> 2] | 0;
...
function _superPropBase(t, o) {
  for (; !{}.hasOwnProperty.call(t, o) && null !== (t = _getPrototypeOf3(t)); ) ;
  return t;
}
function _superPropGet(t, o, e, r) {
  var p = _get(_getPrototypeOf3(t.prototype), o, e);
...
function linkKapsule(kapsulePropName, kapsuleType) {
  ...
  return {
    linkProp: function linkProp(prop) {
      return {
        "default": dummyK[prop](),
        onChange: function onChange7(v2, state) {
...
var GlowMesh = function(_THREE$Mesh) {
  function GlowMesh2(geometry) {
    ...
    _classCallCheck4(this, GlowMesh2);
    _this = _callSuper3(this, GlowMesh2);
  ...
  _inherits3(GlowMesh2, _THREE$Mesh);
  return _createClass4(GlowMesh2);
}(THREE$h.Mesh);
...
var color2ShaderArr = function color2ShaderArr2(str) {
  ...
  if (rgbaMatch) {
    var _rgbaMatch$slice = rgbaMatch.slice(1), _rgbaMatch$slice2 = _slicedToArray5(_rgbaMatch$slice, 4), r = _rgbaMatch$slice2[0], g = _rgbaMatch$slice2[1], b = _rgbaMatch$slice2[2], a = _rgbaMatch$slice2[3];
  ...
  return includeAlpha ? [].concat(_toConsumableArray5(rgbArr), [alpha]) : rgbArr;
};
...
var ThreeDigest = function(_DataBindMapper) {
  function ThreeDigest2(scene) {
    ...
    _classCallCheck4(this, ThreeDigest2);
    _this = _callSuper3(this, ThreeDigest2);
    ...
    _classPrivateFieldInitSpec2(_this, _removeDelay, void 0);
    _this.scene = scene;
    _classPrivateFieldSet22(_dataBindAttr, _this, dataBindAttr);
    _classPrivateFieldSet22(_objBindAttr, _this, objBindAttr);
    _classPrivateFieldSet22(_removeDelay, _this, removeDelay);
    _this.onRemoveObj(function() {
    });
    return _this;
  }
  _inherits3(ThreeDigest2, _DataBindMapper);
  return _createClass4(ThreeDigest2, [{
    key: "onCreateObj",
    value: function onCreateObj(fn) {
      var _this2 = this;
      _superPropGet(ThreeDigest2, "onCreateObj", this)([function(d) {
        var obj = fn(d);
        d[_classPrivateFieldGet22(_objBindAttr, _this2)] = obj;
        obj[_classPrivateFieldGet22(_dataBindAttr, _this2)] = d;
    ...
    value: function onRemoveObj(fn) {
      ...
      _superPropGet(ThreeDigest2, "onRemoveObj", this)([function(obj, dId) {
        ...
        var removeFn = function removeFn2() {
          ...
          emptyObject(obj);
          delete d[_classPrivateFieldGet22(_objBindAttr, _this3)];
        };
        _classPrivateFieldGet22(_removeDelay, _this3) ? setTimeout(removeFn, _classPrivateFieldGet22(_removeDelay, _this3)) : removeFn();
      }]);
      return this;
    }
  }]);
...
var PointsLayerKapsule = index2({
  ...
  update: function update2(state, changedProps) {
    var latAccessor = index(state.pointLat);
    var lngAccessor = index(state.pointLng);
    var altitudeAccessor = index(state.pointAltitude);
    var radiusAccessor = index(state.pointRadius);
    var colorAccessor = index(state.pointColor);
    ...
    state.dataMapper.scene = state.pointsMerge ? new THREE$e.Object3D() : state.scene;
...
var ArcsLayerKapsule = index2({
  ...
  init: function init3(threeObj, state) {
    ...
    state.ticker.onTick.add(function(_, timeDelta) {
      state.dataMapper.entries().map(function(_ref2) {
        var _ref3 = _slicedToArray5(_ref2, 2), obj = _ref3[1];
        return obj;
      }).filter(function(o) {
  ...
  update: function update3(state) {
    var startLatAccessor = index(state.arcStartLat);
    var startLngAccessor = index(state.arcStartLng);
    var endLatAccessor = index(state.arcEndLat);
    var endLngAccessor = index(state.arcEndLng);
    var altitudeAccessor = index(state.arcAltitude);
    var altitudeAutoScaleAccessor = index(state.arcAltitudeAutoScale);
    var strokeAccessor = index(state.arcStroke);
    var colorAccessor = index(state.arcColor);
    var dashLengthAccessor = index(state.arcDashLength);
    var dashGapAccessor = index(state.arcDashGap);
    var dashInitialGapAccessor = index(state.arcDashInitialGap);
    var dashAnimateTimeAccessor = index(state.arcDashAnimateTime);
    ...
    function calcCurve(_ref4) {
      ...
      var getVec = function getVec2(_ref5) {
        var _ref6 = _slicedToArray5(_ref5, 3), lng = _ref6[0], lat = _ref6[1], alt2 = _ref6[2];
      ...
      if (altitude) {
        ...
        var _map = [0.25, 0.75].map(function(t) {
          return [].concat(_toConsumableArray5(interpolate(t)), [altitude * 1.5]);
        }), _map2 = _slicedToArray5(_map, 2), m1Pnt = _map2[0], m2Pnt = _map2[1];
        var curve = _construct(THREE$d.CubicBezierCurve3, _toConsumableArray5([startPnt, m1Pnt, m2Pnt, endPnt].map(getVec)));
        return curve;
      } else {
        var _alt = 1e-3;
        return calcSphereArc.apply(void 0, _toConsumableArray5([[].concat(startPnt, [_alt]), [].concat(endPnt, [_alt])].map(getVec)));
      }
...
var HexBinLayerKapsule = index2({
  ...
  update: function update4(state, changedProps) {
    var latAccessor = index(state.hexBinPointLat);
    var lngAccessor = index(state.hexBinPointLng);
    var weightAccessor = index(state.hexBinPointWeight);
    var altitudeAccessor = index(state.hexAltitude);
    var topColorAccessor = index(state.hexTopColor);
    var sideColorAccessor = index(state.hexSideColor);
    var marginAccessor = index(state.hexMargin);
    ...
    var hexBins = Object.entries(byH3Idx).map(function(_ref3) {
      var _ref4 = _slicedToArray5(_ref3, 2), h3Idx = _ref4[0], points = _ref4[1];
      return {
        h3Idx,
        points,
    ...
    state.dataMapper.scene = state.hexBinMerge ? new THREE$c.Object3D() : state.scene;
    ...
    if (state.hexBinMerge) {
      var hexPointsGeometry = !hexBins.length ? new THREE$c.BufferGeometry() : (BufferGeometryUtils$1.mergeGeometries || BufferGeometryUtils$1.mergeBufferGeometries)(hexBins.map(function(d) {
        ...
        geom.setAttribute("color", array2BufferAttr(_toConsumableArray5(new Array(nVertices)).map(function(_, idx) {
    ...
    function updateObj(obj, d) {
      ...
      var _obj$__hexCenter = _slicedToArray5(obj.__hexCenter, 2), clat = _obj$__hexCenter[0], clng = _obj$__hexCenter[1];
      var geoJson = margin === 0 ? obj.__hexGeoJson : obj.__hexGeoJson.map(function(_ref5) {
        var _ref6 = _slicedToArray5(_ref5, 2), elng = _ref6[0], elat = _ref6[1];
        return [[elng, clng], [elat, clat]].map(function(_ref7) {
          var _ref8 = _slicedToArray5(_ref7, 2), st = _ref8[0], end = _ref8[1];
      ...
      if (!state.hexBinMerge) {
        ...
        [sideColor, topColor].forEach(function(color2) {
          if (!hexMaterials.hasOwnProperty(color2)) {
            ...
            hexMaterials[color2] = applyShaderExtensionToMaterial(new THREE$c.MeshLambertMaterial({
              color: colorStr2Hex(color2),
              transparent: opacity < 1,
              opacity,
              side: THREE$c.DoubleSide
...
var PointsOctree = function() {
  function PointsOctree2(points, neighborhoodAngularDistance) {
    ...
    _classPrivateFieldInitSpec2(this, _points, void 0);
    _classPrivateFieldInitSpec2(this, _pntOctree, void 0);
    _classPrivateFieldInitSpec2(this, _distance, void 0);
    _classPrivateFieldSet22(_points, this, points);
    _classPrivateFieldSet22(_pntOctree, this, (0, import_yaot.default)());
    _classPrivateFieldGet22(_pntOctree, this).init(points.map(function(d) {
      return [d.x, d.y, d.z];
    }).flat());
    _classPrivateFieldSet22(_distance, this, _assertClassBrand2(_PointsOctree_brand, this, _getDistance).call(this, polar2Cartesian3(0, 0), polar2Cartesian3(0, Math.min(180, neighborhoodAngularDistance))));
  }
  return _createClass4(PointsOctree2, [{
    key: "getNearPoints",
    value: function getNearPoints(x, y, z) {
      var _this = this;
      return _classPrivateFieldGet22(_pntOctree, this).intersectSphere(x, y, z, _classPrivateFieldGet22(_distance, this)).map(function(idx) {
        return _classPrivateFieldGet22(_points, _this)[idx / 3];
      });
    }
  }]);
}();
...
var HeatmapsLayerKapsule = index2({
  ...
  update: function update5(state) {
    var pointsAccessor = index(state.heatmapPoints);
    var latPntAccessor = index(state.heatmapPointLat);
    var lngPntAccessor = index(state.heatmapPointLng);
    var weightPntAccessor = index(state.heatmapPointWeight);
    var bandwidthAccessor = index(state.heatmapBandwidth);
    var colorFnAccessor = index(state.heatmapColorFn);
    var saturationAccessor = index(state.heatmapColorSaturation);
    var baseAltitudeAccessor = index(state.heatmapBaseAltitude);
    var topAltitudeAccessor = index(state.heatmapTopAltitude);
    state.dataMapper.onUpdateObj(function(obj, d) {
      ...
      var vertexGeoCoords = vertexCoords.map(function(_ref2) {
        var _ref3 = _slicedToArray5(_ref2, 3), x = _ref3[0], y = _ref3[1], z = _ref3[2];
      ...
      var kdeVals = vertexGeoCoords.map(function(vxCoords, idx) {
        var _vertexCoords$idx = _slicedToArray5(vertexCoords[idx], 3), x = _vertexCoords$idx[0], y = _vertexCoords$idx[1], z = _vertexCoords$idx[2];
      ...
      var colors = _toConsumableArray5(new Array(NUM_COLORS)).map(function(_, idx) {
...
var PolygonsLayerKapsule = index2({
  ...
  update: function update6(state) {
    var geoJsonAccessor = index(state.polygonGeoJsonGeometry);
    var altitudeAccessor = index(state.polygonAltitude);
    var capCurvatureResolutionAccessor = index(state.polygonCapCurvatureResolution);
    var capColorAccessor = index(state.polygonCapColor);
    var capMaterialAccessor = index(state.polygonCapMaterial);
    var sideColorAccessor = index(state.polygonSideColor);
    var sideMaterialAccessor = index(state.polygonSideMaterial);
    var strokeColorAccessor = index(state.polygonStrokeColor);
    var singlePolygons = [];
    state.polygonsData.forEach(function(polygon) {
      ...
      if (geoJson.type === "Polygon") {
        ...
        singlePolygons.push.apply(singlePolygons, _toConsumableArray5(geoJson.coordinates.map(function(coords, idx) {
    ...
    state.dataMapper.onUpdateObj(function(obj, _ref2) {
      ...
      var _obj$children = _slicedToArray5(obj.children, 2), conicObj = _obj$children[0], strokeObj = _obj$children[1];
...
function objMatch(obj, attrs) {
  ...
  return Object.entries(attrs).every(function(_ref3) {
    var _ref4 = _slicedToArray5(_ref3, 2), k = _ref4[0], v2 = _ref4[1];
...
var HexedPolygonsLayerKapsule = index2({
  ...
  update: function update7(state) {
    var geoJsonAccessor = index(state.hexPolygonGeoJsonGeometry);
    var colorAccessor = index(state.hexPolygonColor);
    var altitudeAccessor = index(state.hexPolygonAltitude);
    var resolutionAccessor = index(state.hexPolygonResolution);
    var marginAccessor = index(state.hexPolygonMargin);
    var useDotsAccessor = index(state.hexPolygonUseDots);
    var curvatureResolutionAccessor = index(state.hexPolygonCurvatureResolution);
    var dotResolutionAccessor = index(state.hexPolygonDotResolution);
    state.dataMapper.onUpdateObj(function(obj, d) {
      ...
      if (Object.keys(targetD).some(function(k) {
        ...
        var applyUpdate = function applyUpdate2(td) {
          ...
          obj.geometry = !hexBins.length ? new THREE$9.BufferGeometry() : (BufferGeometryUtils.mergeGeometries || BufferGeometryUtils.mergeBufferGeometries)(hexBins.map(function(h) {
            var _h$hexCenter = _slicedToArray5(h.hexCenter, 2), clat = _h$hexCenter[0], clng = _h$hexCenter[1];
            if (useDots) {
              ...
              var _geoJson = margin2 === 0 ? h.hexGeoJson : h.hexGeoJson.map(function(_ref2) {
                var _ref3 = _slicedToArray5(_ref2, 2), elng = _ref3[0], elat = _ref3[1];
                return [[elng, clng], [elat, clat]].map(function(_ref4) {
                  var _ref5 = _slicedToArray5(_ref4, 2), st = _ref5[0], end = _ref5[1];
...
function interpolateVectors(fromPnts, toPnts) {
  var extendArr = function extendArr2(arr, length) {
    ...
    return [].concat(_toConsumableArray5(arr), _toConsumableArray5(Array(length - arr.length).fill(repeatItem)));
  };
  var arrLength = Math.max(fromPnts.length, toPnts.length);
  var interpolator = array_default.apply(void 0, _toConsumableArray5([fromPnts, toPnts].map(function(pnts) {
...
var PathsLayerKapsule = index2({
  ...
  update: function update8(state) {
    var pointsAccessor = index(state.pathPoints);
    var pointLatAccessor = index(state.pathPointLat);
    var pointLngAccessor = index(state.pathPointLng);
    var pointAltAccessor = index(state.pathPointAlt);
    var strokeAccessor = index(state.pathStroke);
    var colorAccessor = index(state.pathColor);
    var dashLengthAccessor = index(state.pathDashLength);
    var dashGapAccessor = index(state.pathDashGap);
    var dashInitialGapAccessor = index(state.pathDashInitialGap);
    var dashAnimateTimeAccessor = index(state.pathDashAnimateTime);
    state.dataMapper.onUpdateObj(function(group2, path) {
      ...
      var applyUpdate = function applyUpdate2(td) {
        ...
        if (useFatLine) {
          var _ref4;
          obj.geometry.setPositions((_ref4 = []).concat.apply(_ref4, _toConsumableArray5(kPoints.map(function(_ref5) {
    ...
    function calcPath(points, latAccessor, lngAccessor, altAccessor, angularResolution) {
      ...
      var getVec = function getVec2(_ref6) {
        var _ref7 = _slicedToArray5(_ref6, 3), lat = _ref7[0], lng = _ref7[1], alt = _ref7[2];
...
var TilesLayerKapsule = index2({
  ...
  update: function update9(state) {
    var latAccessor = index(state.tileLat);
    var lngAccessor = index(state.tileLng);
    var altitudeAccessor = index(state.tileAltitude);
    var widthAccessor = index(state.tileWidth);
    var heightAccessor = index(state.tileHeight);
    var useGlobeProjectionAccessor = index(state.tileUseGlobeProjection);
    var materialAccessor = index(state.tileMaterial);
    var curvatureResolutionAccessor = index(state.tileCurvatureResolution);
    state.dataMapper.onUpdateObj(function(obj, d) {
...
var LabelsLayerKapsule = index2({
  ...
  init: function init10(threeObj, state, _ref) {
    ...
    state.dataMapper = new ThreeDigest(threeObj, {
      ...
      var textObj = new THREE$5.Mesh(void 0, material);
      obj.add(textObj);
  ...
  update: function update10(state) {
    var latAccessor = index(state.labelLat);
    var lngAccessor = index(state.labelLng);
    var altitudeAccessor = index(state.labelAltitude);
    var textAccessor = index(state.labelText);
    var sizeAccessor = index(state.labelSize);
    var rotationAccessor = index(state.labelRotation);
    var colorAccessor = index(state.labelColor);
    var includeDotAccessor = index(state.labelIncludeDot);
    var dotRadiusAccessor = index(state.labelDotRadius);
    var dotOrientationAccessor = index(state.labelDotOrientation);
    var orientations = /* @__PURE__ */ new Set(["right", "top", "bottom"]);
    var pxPerDeg = 2 * Math.PI * GLOBE_RADIUS / 360;
    state.dataMapper.onUpdateObj(function(obj, d) {
      var _obj$children = _slicedToArray5(obj.children, 2), dotObj = _obj$children[0], textObj = _obj$children[1];
      var _textObj$children = _slicedToArray5(textObj.children, 1), bbObj = _textObj$children[0];
      var color2 = colorAccessor(d);
      var opacity = colorAlpha(color2);
      ...
      bbObj.geometry = _construct(THREE$5.BoxGeometry, _toConsumableArray5(new THREE$5.Vector3().subVectors(textObj.geometry.boundingBox.max, textObj.geometry.boundingBox.min).toArray()));
...
var RingsLayerKapsule = index2({
  ...
  init: function init11(threeObj, state, _ref) {
    ...
    state.ticker.onTick.add(function(time2) {
      ...
      var colorAccessor = index(state.ringColor);
      var altitudeAccessor = index(state.ringAltitude);
      var maxRadiusAccessor = index(state.ringMaxRadius);
      var propagationSpeedAccessor = index(state.ringPropagationSpeed);
      var repeatPeriodAccessor = index(state.ringRepeatPeriod);
      state.dataMapper.entries().filter(function(_ref2) {
        var _ref3 = _slicedToArray5(_ref2, 2), o = _ref3[1];
        return o;
      }).forEach(function(_ref4) {
        var _ref5 = _slicedToArray5(_ref4, 2), d = _ref5[0], obj = _ref5[1];
  ...
  update: function update11(state) {
    var latAccessor = index(state.ringLat);
    var lngAccessor = index(state.ringLng);
    var altitudeAccessor = index(state.ringAltitude);
...
var HtmlElementsLayerKapsule = index2({
  ...
  methods: {
    updateObjVisibility: function updateObjVisibility(state, obj) {
      ...
      var objs = obj ? [obj] : state.dataMapper.entries().map(function(_ref) {
        var _ref2 = _slicedToArray5(_ref, 2), o = _ref2[1];
        return o;
      }).filter(function(d) {
        return d;
      });
  ...
  init: function init12(threeObj, state, _ref3) {
    ...
    state.dataMapper = new ThreeDigest(threeObj, {
      ...
      var elem = index(state.htmlElement)(d);
      var obj = new THREE$2.CSS2DObject(elem);
      obj.__globeObjType = "html";
      return obj;
    });
  },
  update: function update12(state, changedProps) {
    var _this = this;
    var latAccessor = index(state.htmlLat);
    var lngAccessor = index(state.htmlLng);
    var altitudeAccessor = index(state.htmlAltitude);
...
var ObjectsLayerKapsule = index2({
  ...
  init: function init13(threeObj, state) {
    ...
    state.dataMapper = new ThreeDigest(threeObj, {
      ...
      var obj = index(state.objectThreeObject)(d);
  ...
  update: function update13(state, changedProps) {
    var latAccessor = index(state.objectLat);
    var lngAccessor = index(state.objectLng);
    var altitudeAccessor = index(state.objectAltitude);
    var parallelAccessor = index(state.objectFacesSurface);
    var rotationAccessor = index(state.objectRotation);
...
var CustomLayerKapsule = index2({
  ...
  init: function init14(threeObj, state) {
    ...
    state.dataMapper = new ThreeDigest(threeObj, {
      ...
      var obj = index(state.customThreeObject)(d, GLOBE_RADIUS);
      if (obj) {
  ...
  update: function update14(state, changedProps) {
    ...
    var customObjectUpdateAccessor = index(state.customThreeObjectUpdate);
...
var linkedGlobeLayerProps = Object.assign.apply(Object, _toConsumableArray5(["globeImageUrl", "bumpImageUrl", "showGlobe", "showGraticules", "showAtmosphere", "atmosphereColor", "atmosphereAltitude"].map(function(p) {
  return _defineProperty({}, p, bindGlobeLayer.linkProp(p));
})));
var linkedGlobeLayerMethods = Object.assign.apply(Object, _toConsumableArray5(["globeMaterial"].map(function(p) {
  return _defineProperty({}, p, bindGlobeLayer.linkMethod(p));
})));
var bindPointsLayer = linkKapsule("pointsLayer", PointsLayerKapsule);
var linkedPointsLayerProps = Object.assign.apply(Object, _toConsumableArray5(["pointsData", "pointLat", "pointLng", "pointColor", "pointAltitude", "pointRadius", "pointResolution", "pointsMerge", "pointsTransitionDuration"].map(function(p) {
  return _defineProperty({}, p, bindPointsLayer.linkProp(p));
})));
var bindArcsLayer = linkKapsule("arcsLayer", ArcsLayerKapsule);
var linkedArcsLayerProps = Object.assign.apply(Object, _toConsumableArray5(["arcsData", "arcStartLat", "arcStartLng", "arcEndLat", "arcEndLng", "arcColor", "arcAltitude", "arcAltitudeAutoScale", "arcStroke", "arcCurveResolution", "arcCircularResolution", "arcDashLength", "arcDashGap", "arcDashInitialGap", "arcDashAnimateTime", "arcsTransitionDuration"].map(function(p) {
  return _defineProperty({}, p, bindArcsLayer.linkProp(p));
})));
var bindHexBinLayer = linkKapsule("hexBinLayer", HexBinLayerKapsule);
var linkedHexBinLayerProps = Object.assign.apply(Object, _toConsumableArray5(["hexBinPointsData", "hexBinPointLat", "hexBinPointLng", "hexBinPointWeight", "hexBinResolution", "hexMargin", "hexTopCurvatureResolution", "hexTopColor", "hexSideColor", "hexAltitude", "hexBinMerge", "hexTransitionDuration"].map(function(p) {
  return _defineProperty({}, p, bindHexBinLayer.linkProp(p));
})));
var bindHeatmapsLayer = linkKapsule("heatmapsLayer", HeatmapsLayerKapsule);
var linkedHeatmapsLayerProps = Object.assign.apply(Object, _toConsumableArray5(["heatmapsData", "heatmapPoints", "heatmapPointLat", "heatmapPointLng", "heatmapPointWeight", "heatmapBandwidth", "heatmapColorFn", "heatmapColorSaturation", "heatmapBaseAltitude", "heatmapTopAltitude", "heatmapsTransitionDuration"].map(function(p) {
...
var linkedHexedPolygonsLayerProps = Object.assign.apply(Object, _toConsumableArray5(["hexPolygonsData", "hexPolygonGeoJsonGeometry", "hexPolygonColor", "hexPolygonAltitude", "hexPolygonResolution", "hexPolygonMargin", "hexPolygonUseDots", "hexPolygonCurvatureResolution", "hexPolygonDotResolution", "hexPolygonsTransitionDuration"].map(function(p) {
...
var linkedPolygonsLayerProps = Object.assign.apply(Object, _toConsumableArray5(["polygonsData", "polygonGeoJsonGeometry", "polygonCapColor", "polygonCapMaterial", "polygonSideColor", "polygonSideMaterial", "polygonStrokeColor", "polygonAltitude", "polygonCapCurvatureResolution", "polygonsTransitionDuration"].map(function(p) {
  return _defineProperty({}, p, bindPolygonsLayer.linkProp(p));
})));
var bindPathsLayer = linkKapsule("pathsLayer", PathsLayerKapsule);
var linkedPathsLayerProps = Object.assign.apply(Object, _toConsumableArray5(["pathsData", "pathPoints", "pathPointLat", "pathPointLng", "pathPointAlt", "pathResolution", "pathColor", "pathStroke", "pathDashLength", "pathDashGap", "pathDashInitialGap", "pathDashAnimateTime", "pathTransitionDuration"].map(function(p) {
  return _defineProperty({}, p, bindPathsLayer.linkProp(p));
})));
var bindTilesLayer = linkKapsule("tilesLayer", TilesLayerKapsule);
var linkedTilesLayerProps = Object.assign.apply(Object, _toConsumableArray5(["tilesData", "tileLat", "tileLng", "tileAltitude", "tileWidth", "tileHeight", "tileUseGlobeProjection", "tileMaterial", "tileCurvatureResolution", "tilesTransitionDuration"].map(function(p) {
  return _defineProperty({}, p, bindTilesLayer.linkProp(p));
})));
var bindLabelsLayer = linkKapsule("labelsLayer", LabelsLayerKapsule);
var linkedLabelsLayerProps = Object.assign.apply(Object, _toConsumableArray5(["labelsData", "labelLat", "labelLng", "labelAltitude", "labelRotation", "labelText", "labelSize", "labelTypeFace", "labelColor", "labelResolution", "labelIncludeDot", "labelDotRadius", "labelDotOrientation", "labelsTransitionDuration"].map(function(p) {
  return _defineProperty({}, p, bindLabelsLayer.linkProp(p));
})));
var bindRingsLayer = linkKapsule("ringsLayer", RingsLayerKapsule);
var linkedRingsLayerProps = Object.assign.apply(Object, _toConsumableArray5(["ringsData", "ringLat", "ringLng", "ringAltitude", "ringColor", "ringResolution", "ringMaxRadius", "ringPropagationSpeed", "ringRepeatPeriod"].map(function(p) {
...
var linkedHtmlElementsLayerProps = Object.assign.apply(Object, _toConsumableArray5(["htmlElementsData", "htmlLat", "htmlLng", "htmlAltitude", "htmlElement", "htmlTransitionDuration"].map(function(p) {
...
var linkedObjectsLayerProps = Object.assign.apply(Object, _toConsumableArray5(["objectsData", "objectLat", "objectLng", "objectAltitude", "objectRotation", "objectFacesSurface", "objectThreeObject"].map(function(p) {
  return _defineProperty({}, p, bindObjectsLayer.linkProp(p));
})));
var bindCustomLayer = linkKapsule("customLayer", CustomLayerKapsule);
var linkedCustomLayerProps = Object.assign.apply(Object, _toConsumableArray5(["customLayerData", "customThreeObject", "customThreeObjectUpdate"].map(function(p) {
...
var Globe = index2({
  ...
  methods: _objectSpread2({
    ...
    setPointOfView: function setPointOfView(state, camera) {
      ...
      var isInView = void 0;
      if (state.scene && camera instanceof THREE3.Camera) {
        var frustum, globeCenter;
        isInView = function isInView2(pos) {
          var wPos = pos.clone().applyMatrix4(state.scene.matrixWorld);
          if (!frustum) {
            camera.updateMatrix();
            camera.updateMatrixWorld();
            frustum = new THREE3.Frustum();
            frustum.setFromProjectionMatrix(new THREE3.Matrix4().multiplyMatrices(camera.projectionMatrix, camera.matrixWorldInverse));
          }
          if (!frustum.containsPoint(wPos)) return false;
          if (!globeCenter) {
            globeCenter = state.scene.getWorldPosition(new THREE3.Vector3());
          }
          var pov2 = camera.position;
          return pov2.distanceTo(wPos) < pov2.distanceTo(globeCenter);
        };
      }
  ...
  stateInit: function stateInit4() {
    ...
    return _objectSpread2(_objectSpread2({
      ...
      layersThatNeedInViewChecker: Object.values(layers2).filter(function(l) {
  ...
  update: function update15(state) {
  }
});
function fromKapsule(kapsule) {
  ...
  var Globe2 = function(_baseClass) {
    function Globe3() {
      var _this;
      _classCallCheck4(this, Globe3);
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      _this = _callSuper3(this, Globe3, [].concat(args));
      _this.__kapsuleInstance = _construct(kapsule, [].concat(_toConsumableArray5(initKapsuleWithSelf ? [_this] : []), args));
      return _this;
    }
    _inherits3(Globe3, _baseClass);
    return _createClass4(Globe3);
  }(baseClass);
